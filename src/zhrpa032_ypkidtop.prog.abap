...
*      hiredate9907 LIKE p0001-begda,
*      kidbegda9907 LIKE p0001-begda,
*      kidendda9907 LIKE p0001-endda.
...
*data: begin of it9yd1 occurs 200.
*        include structure t9yd1.
*data: cflag(1) type c.
*data: end of it9yd1.
...
*data: begin of i9005 occurs 0.
*data: pernr like p9005-pernr.
*      include structure ps9005.
*data: end of i9005.
