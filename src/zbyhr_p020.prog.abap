...
*&
*&---------------------------------------------------------------------*
REPORT ZBYHR_P020 NO STANDARD PAGE HEADING.
...
PARAMETERS     : formular  LIKE ppe51_1000-forml DEFAULT 'MD3'
...
****    CHECK pernr-btrtl IN pnpbtrtl.
    ...
    "burada direk yazdırarakta submit edilebilir
    "ama her personelin her ayı bir sayfa olarak spoola gider
  "koşul eklendi sy 16.01.2025
if p0001 is not initial.
    SUBMIT htrcedt0 WITH SELECTION-TABLE i_rsparams
                                    AND RETURN.
endif.
    "programda personel no ile memory atar
    "bu atılanı buradan f0 stru. doldurarak okuruz
...
*  form_wa-ltype = space.
**  form_wa-linda+12(8) = odeme.
*  MODIFY gt_xform FROM form_wa INDEX 2.
  NEW-PAGE.
